...
Next go to this url: https://projectsc.popdata.bc.ca/profile/personal_access_tokens
...
You next need to "Join" the repo for each particular project. Navigate to this url: https://projectsc.popdata.bc.ca/v1/selfserve/main and click the "Join Repo" tab. Click the radio button next to the repo labeled "dipr". You have now joined that repo for the project you are in.  
